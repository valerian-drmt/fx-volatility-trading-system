...
full table scan once the table got large:
  ...
  * the retention prune (``DELETE WHERE timestamp < cutoff``) -> covered by the
    timestamp index.

Index-only, additive, no column change -> no writer/reader/payload cascade.

Revision ID: 045_index_open_position_history
Revises: 044_drop_orders_trades
...
revision: str = "045_index_open_position_history"
down_revision: str | None = "044_drop_orders_trades"
