...
class PortfolioPanel(QWidget):
    ...
    def __init__(self) -> None:
        ...
        summary_form.addRow("Top exposure:", self.exposure_label)
    ...
    def _set_currency_holdings(self, summary: list[Any]) -> None:
        ...
        self.usd_balance_label.setText(self._format_amount(usd) if usd is not None else "--")
        self.eur_balance_label.setText(self._format_amount(eur) if eur is not None else "--")
